...
function App() {
  ...
  return (
   <main className="flex flex-col items-center justify-center bg-[#1F1F1F] w-min p-6 xl:p-10 rounded-[12px] font-custom">
    ...
    <p className="text-sm text-[#C4F82A] font-custom-semibold">London, United Kingdom</p>
